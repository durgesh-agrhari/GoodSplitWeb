            ...
            <div className='container'>
                <div className='hero__wrapper'>
                    <div className='hero__content'>
                        <div className='left1'>
                            <h2>Download GoodSplit App</h2>
                            <h2 >Make you mony split and save and know where ites go </h2>
                            <h3 className='highlight'>Download Now </h3>
                        </div> <br />
                        <p className='discription'>Find your money history on GoodSplit</p>
